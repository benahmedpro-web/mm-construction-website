        ...
        <div className="border-t border-[#D9D4CC] py-10 px-5 bg-white">
          <div className="max-w-[780px] mx-auto">
            ...
            <Link href="/annonces/maison-ossature-bois-gex-01/" className="flex gap-5 items-start no-underline group border border-[#D9D4CC] hover:border-[#BA7517] transition-colors p-4">
              ...
              <div>
                <div className="text-[15px] font-bold text-[#2C2C2A] group-hover:text-[#BA7517] transition-colors">Maison ossature bois · Gex (01) — Pays de Gex</div>
                <div className="text-[13px] text-[#888780] mt-1">130 m² · 400 000 € · Livré — budget respecté · Artisans locaux sélectionnés</div>
