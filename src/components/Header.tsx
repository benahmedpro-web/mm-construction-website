    ...
    <header className="bg-white w-full border-b border-[#D9D4CC] relative z-50">
      ...
      <div className="border-b border-[#D9D4CC]">
        <div className="max-w-[1200px] mx-auto px-5 py-2 flex items-center justify-end gap-6">
          ...
          <Link href="/zone-intervention/" className="flex items-center gap-1.5 text-[#888780] text-[13px] no-underline hover:text-[#BA7517] transition-colors">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
            Zone d&apos;intervention
          </Link>
          <Link href="/realisations/" className="flex items-center gap-1.5 text-[#888780] text-[13px] no-underline hover:text-[#BA7517] transition-colors">
      ...
      <div className="max-w-[1200px] mx-auto px-5 py-3 flex items-center gap-8">
        ...
        <nav className="hidden lg:flex items-center gap-0">
          ...
          <Link href="/zone-intervention/" className="text-[15px] font-medium uppercase tracking-wide px-4 py-2 text-[#2C2C2A] hover:text-[#BA7517] transition-colors no-underline">
            Zone
          </Link>
